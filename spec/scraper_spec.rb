...
RSpec.describe BlueCrossPets::Scraper do
  ...
  describe "#scrape_index" do
    it 'is an index method that correctly scrapes names, breed, gender, age, profile URL, and availability from Blue Cross and returns an array of hashes for each animal' do
      dog_index_url = "https://www.bluecross.org.uk/rehome/dog"
      scraped_dogs = BlueCrossPets::Scraper.new.scrape_index(dog_index_url)
      ...
      scraped_cats = BlueCrossPets::Scraper.new.scrape_index(cat_index_url)
  ...
  describe "#scrape_profile" do
    it "is an index method that scrapes the animal's profile page and returns a hash of attributes describing that animal" do
      profile_url = "https://www.bluecross.org.uk/pet/luna-1126964?type=adopt"
      scraped_dog = BlueCrossPets::Scraper.new.scrape_profile(profile_url)
